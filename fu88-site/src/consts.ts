...
export const CATEGORY_INTRO: Record<string, string> = {
  'platform': '第一次玩富88？這裡帶你認識平台怎麼運作、有哪些遊戲與服務、新手該從哪裡開始。看完就能快速上手，知道每個功能在哪、怎麼用。',
  ...
  'promotions': '新會員 288 體驗金、每日簽到、首存加碼、返水回饋…這裡教你把富88 的優惠領好領滿，並看懂流水（打碼量）規則，避免領了卻用不到。',
...
// 根層保留字（reservedSlugSet）：分類／靜態頁／Hub 共用根命名空間，新增根層頁或文章 slug 前先查
